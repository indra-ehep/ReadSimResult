...
#---------------------------------------------
condorOutDir1=/eos/cms/store/group/dpg_hgcal/comm_hgcal/geomval/etaphi_debug_reeval/CMSSW_12_5_0_pre5/$geom
#condorOutDir1=/eos/user/i/idas/SimOut/geomval/etaphi_debug/$geom
condorOutDir=/cms/store/user/idas/SimOut/geomval/etaphi_debug_reeval/CMSSW_12_5_0_pre5/$geom
if [ -z ${_CONDOR_SCRATCH_DIR} ] ; then
    echo "Running Interactively" ;
else
